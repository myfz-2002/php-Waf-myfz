<?php
//用户唯一key
define('WEBSCAN_U_KEY', 'dcc20a8db07667376916d96d6756794aa70');
//数据回调统计地址
define('WEBSCAN_API_LOG', 'http://输入你的链接/fanhu/websc.php');
//版本更新地址
...
//$webscan_white_url = array('index.php' => 'mod=admin-set','index.php' => 'fpl#post.htm');
